...
const counterSchema = yup.object().shape({
    ...
    copiasPB: yup.string()
        .matches(/^\d+$/, 'Cópias P&B deve ser um número'),
    impressoesPB: yup.string()
        .matches(/^\d+$/, 'Impressões P&B deve ser um número'),
    copiasColor: yup.string()
        .matches(/^\d+$/, 'Cópias color deve ser um número'),
    impressoesColor: yup.string()
        .matches(/^\d+$/, 'Impressões color deve ser um número'),
    contadorGeral: yup.string()
        .matches(/^\d+$/, 'Contador geral deve ser um número'),
        ...
        <div id="counter-form-card">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div id="form-buttons">
                    ...
                    <button data-testid="button-state" className="form-button" type="submit" id="insert-bnt" disabled={!isValid}>INSERIR</button>
                </div>
